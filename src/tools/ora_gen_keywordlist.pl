#----------------------------------------------------------------------
#
# ora_gen_keywordlist.pl
#	Perl script that transforms a list of keywords into a OraScanKeywordList
#	data structure that can be passed to OraScanKeywordLookup().
#
...
# variable named according to the -v switch ("OraScanKeywords" by default).
...
{
	die <<EOM;
Usage: ora_gen_keywordlist.pl [--output/-o <path>] [--varname/-v <varname>] [--extern/-e] [--[no-]case-fold] input_file
    --output        Output directory (default '.')
    --varname       Name for ScanKeywordList variable (default 'OraScanKeywords')
    --extern        Allow the ScanKeywordList variable to be globally visible
    --no-case-fold  Keyword matching is to be case-sensitive

ora_gen_keywordlist.pl transforms a list of keywords into a ScanKeywordList.
