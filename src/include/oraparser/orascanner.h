 ...
 *
 * The core scanner is also used by PL/SQL, so we provide a public API
 ...
 *
 * src/include/oraparser/orascanner.h
 *
 *-------------------------------------------------------------------------
 */

#ifndef ORA_SCANNER_H
#define ORA_SCANNER_H
 ...
 */
typedef union ora_core_YYSTYPE
{
 ...
 */
typedef struct ora_core_yy_extra_type
{
	/*
...
/* Entry points in oraparser/orascan.l */
extern ora_core_yyscan_t ora_scanner_init(const char *str,
								  ora_core_yy_extra_type *yyext,
								  const ScanKeywordList *keywordlist,
								  const uint16 *keyword_tokens);
extern void ora_scanner_finish(ora_core_yyscan_t yyscanner);
extern int	ora_core_yylex(ora_core_YYSTYPE *yylval_param, YYLTYPE *yylloc_param,
							ora_core_yyscan_t yyscanner);
extern int	ora_scanner_errposition(int location, ora_core_yyscan_t yyscanner);
extern void ora_setup_scanner_errposition_callback(OraScannerCallbackState *scbstate,
											   ora_core_yyscan_t yyscanner,
											   int location);
