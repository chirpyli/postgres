 ...
 *
 * IDENTIFICATION
 *	  src/backend/oraparser/oragram.y
 *
 * HISTORY
...
static void ora_base_yyerror(YYLTYPE *yylloc, ora_core_yyscan_t yyscanner,
						 const char *msg);
...
static void check_qualified_name(List *names, ora_core_yyscan_t yyscanner);
static List *check_func_name(List *names, ora_core_yyscan_t yyscanner);
static List *check_indirection(List *indirection, ora_core_yyscan_t yyscanner);
...
static RangeVar *makeRangeVarFromAnyName(List *names, int position, ora_core_yyscan_t yyscanner);
...
%parse-param {ora_core_yyscan_t yyscanner}
%lex-param   {ora_core_yyscan_t yyscanner}
 ...
 */
static void
ora_base_yyerror(YYLTYPE *yylloc, ora_core_yyscan_t yyscanner, const char *msg)
{
	parser_yyerror(msg);
}
 ...
 */
static void
check_qualified_name(List *names, ora_core_yyscan_t yyscanner)
{
	ListCell   *i;
 ...
 */
static List *
check_func_name(List *names, ora_core_yyscan_t yyscanner)
{
	ListCell   *i;
 ...
 */
static List *
check_indirection(List *indirection, ora_core_yyscan_t yyscanner)
{
	ListCell *l;
 ...
 */
static RangeVar *
makeRangeVarFromAnyName(List *names, int position, ora_core_yyscan_t yyscanner)
{
 ...
 */
static void
preprocess_pubobj_list(List *pubobjspec_list, ora_core_yyscan_t yyscanner)
{
	ListCell   *cell;
